...
1. 仅仅单独一个main.c与CMakeLists.txt
    ...
    <img src='https://raw.githubusercontent.com/chen810/lolibed/master/20201006153552.png' alt="加载失败" width="400px">
...
2. 将编译文件单独区分开来存入build文件
    ...
    <img src='https://raw.githubusercontent.com/chen810/lolibed/master/20201006154914.png' alt="加载失败" width="400px">

    则以下文件自动移动到build中

    <img src='https://raw.githubusercontent.com/chen810/lolibed/master/20201006154837.png' alt="加载失败" width="400px">
...
3. 存在多个源文件时（额外自己写的库文件等）
    ...
    <img src='https://raw.githubusercontent.com/chen810/lolibed/master/20201006201631.png' alt="加载失败" width="400px">
...
4. 生成所需库文件（以下PROJECT_NAME=A3，LIB_NAME=hello）
    ...
    <img src='https://raw.githubusercontent.com/chen810/lolibed/master/20201006205520.png' alt="加载失败" width="400px">
